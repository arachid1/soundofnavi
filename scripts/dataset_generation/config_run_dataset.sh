...
# v17 -> all in 80 channels cochlear
AUGM_VERSION=v0
...
/home/alilerachidi/anaconda3/envs/ObjectDetection/bin/python -u generate_dataset.py --params "$DATASET_PARAMS" --wav_params "$WAV_PARAMS" --spec_params "$SPEC_PARAMS"

...
# kills process
lsof -i :$PORT | tail -n +2 | awk '{system("kill -s 9 " $2)}' &> /dev/null;

# launches web page
open -a "Google Chrome" http://localhost:$PORT
tensorboard --logdir=$LOG_DIR --port $PORT --reload_interval=5
...
#tensorboard --logdir=../../../cache/tf_learn_pattern_detection___conv2d___20200723_171537___data_slidingwindow_log_spectrogram___template___100/logs --por
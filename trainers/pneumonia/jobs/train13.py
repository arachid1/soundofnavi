...
class Model(pl.LightningModule):
    ...
    def on_after_backward(self):
        print(self.spec_layer.wsin.grad.shape)
...
def train_model(datasets, model_to_be_trained, spec_aug_params, audio_aug_params, parse_function):
    ...
    for threshold in [10, 25, 50, 100]:
        ...
        trainer = pl.Trainer(max_epochs=parameters.n_epochs, gpus=1)
        ...
        with torch.no_grad():
                for local_batch, local_labels in testloader:
                    ...
                    visualize_spec_bis(last_epoch_out, parameters.sr, "temp/outputs_{}_".format(threshold), title="orig_index_{}_label_{}".format(index, label_to_track))
                    break

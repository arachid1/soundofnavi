...
def train_model(datasets, model_to_be_trained, spec_aug_params, audio_aug_params, parse_function, label_passed):
    ...
    for i in range(len(train_audios_c_dict)):
        ...
        # teacher
        teacher = model_to_be_trained(num_outputs=parameters.n_classes, _frontend=parameters.teacher_frontend_argument)
        ...
        student = model_to_be_trained(num_outputs=parameters.n_classes, _frontend=parameters.student_frontend_argument)
        shape = (None, parameters.audio_length*parameters.sr)
...
if __name__ == "__main__":
    ...
    parameters.teacher_frontend_argument = leaf_frontend.MelFilterbanks(
    ...
    parameters.student_frontend_argument = leaf_frontend.Leaf(
            sample_rate=parameters.sr, 
            n_filters=parameters.n_filters, 
            # n_fft = parameters.n_fft,
            window_len = parameters.window_len,

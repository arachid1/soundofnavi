...
from modules.models.leaf_model9_model_efnet1_175_1 import leaf_model9_model_efnet1_175_1
...
if __name__ == "__main__":
    ...
    parameters.code = 1
    launch_job({"Bd": 0, "Jordan": 0, "Icbhi": 1, "Perch": 0, "Ant": 0, "SimAnt": 0,}, leaf_model9_model_efnet1_175_1, spec_aug_params, audio_aug_params, None, [1,0])
    print("Job dir: {}".format(parameters.job_dir))

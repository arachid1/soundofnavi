...
from modules.models.leaf_MoE_model9_model import leaf_MoE_model9_model
...
def train_model(datasets, model_to_be_trained, spec_aug_params, audio_aug_params, parse_function):
    ...
    # model setting
    model = model_to_be_trained(num_outputs=parameters.n_classes, frontend=frontend.Leaf(sample_rate=16000, n_filters=80), encoder=None)
...
if __name__ == "__main__":
    ...
    spec_aug_params = []
    audio_aug_params = []
    launch_job({"Bd": 0, "Jordan": 0, "Icbhi": 1, "Perch": 1, "Ant": 1, "SimAnt": 1,}, leaf_MoE_model9_model, spec_aug_params, audio_aug_params, None)

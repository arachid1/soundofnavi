...
def train_model(datasets, model_to_be_trained, spec_aug_params, audio_aug_params, parse_function, label_passed):
    ...
    for i in range(len(train_audios_c_dict)):
        ...
        # print(_train_samples[0])
        # print(_val_samples[0])
        # exit()
        ...
        # print(len(b4kfold_val_samples))
        # print(len(b4kfold_train_samples))
        # print(len(b4kfold_train_samples[0]))
        # exit()
        ...
        # teacher
        teacher = model_to_be_trained(num_outputs=parameters.n_classes, _frontend=leaf_frontend.Leaf(sample_rate=16000, n_filters=80), 
                            normalize=True, encoder=None, weights=list(weights.values()), activate_weights=parameters.class_weights)

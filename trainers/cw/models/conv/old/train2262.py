...
def train_model(train_file, job_dir, params, wav_params, spec_params, model_to_be_trained, wav_0, spec_0, job_count):
    ...
    if concat:
        ...
        if augmentation:
            ...
            train_samples, train_labels = manage_label_augmentations(train_samples, wav_add, spec_add, wav_0, spec_0, job_version, wav_path, time_masking, frequency_masking, loudness, dataset_path, label=0)
...
if __name__ == "__main__":
    ...
    wav_0 = 200
    spec_0 = 200
    train_model(train_file, job_dir, params, wav_params, spec_params, model9, wav_0, spec_0, job_count=0)
    print("-----------------------")
    wav_0 = 500
    spec_0 = 500
    print("New wav quantity for label 0: {}".format(wav_0))
    train_model(train_file, job_dir, params, wav_params, spec_params, model9, wav_0, spec_0, job_count=1)
    print("-----------------------")
    spec_params['ADD'] = 1
    print("New augm params: {}".format(spec_params))
    train_model(train_file, job_dir, params, wav_params, spec_params, model9, wav_0, spec_0, job_count=1)
    print("-----------------------")
    spec_params['ADD'] = 0
    wav_params['WAV_PATH'] = 'v42'
    print("New augm params: {}".format(spec_params))
    print("New augm params: {}".format(wav_params))
    train_model(train_file, job_dir, params, wav_params, spec_params, model9, wav_0, spec_0, job_count=1)

...
from modules.models.leaf_model9_model_efnet1_174_3 import leaf_model9_model_efnet1_174_3
...
def train_model(datasets, model_to_be_trained, spec_aug_params, audio_aug_params, parse_function, label_passed):
    ...
    for i in range(len(train_audios_c_dict)):
        ...
        teacher_2nd = model_to_be_trained(num_outputs=parameters.n_classes, _frontend=leaf_frontend.MelFilterbanks(
            sample_rate=parameters.sr, 
            n_filters=parameters.n_filters, 
            # n_fft = 256,
            # window_len = 50,
        ...
        trained_weights = teacher.get_weights()
        teacher_2nd.set_weights(trained_weights)

        teacher_2nd._frontend = leaf_frontend.Leaf(
            sample_rate=parameters.sr, 
            n_filters=parameters.n_filters, 
            # n_fft = 256,
            # window_len = 50,
        ...
        teacher_2nd._pool.layers[0].trainable = False
        teacher_2nd.build(shape)
        ...
        teacher_2nd.summary(line_length=110)

        history = teacher_2nd.fit(
            train_dataset,
            epochs=parameters.n_epochs,
            verbose=2,
            class_weight=weights,
...
if __name__ == "__main__":
    ...
    launch_job({"Bd": 0, "Jordan": 0, "Icbhi": 1, "Perch": 0, "Ant": 0, "SimAnt": 0,}, leaf_model9_model_efnet1_174_1, spec_aug_params, audio_aug_params, None, [1,0])
    print("Job dir: {}".format(parameters.job_dir))


    launch_job({"Bd": 0, "Jordan": 0, "Icbhi": 1, "Perch": 0, "Ant": 0, "SimAnt": 0,}, leaf_model9_model_efnet1_174_2, spec_aug_params, audio_aug_params, None, [1,0])
    print("Job dir: {}".format(parameters.job_dir))

    launch_job({"Bd": 0, "Jordan": 0, "Icbhi": 1, "Perch": 0, "Ant": 0, "SimAnt": 0,}, leaf_model9_model_efnet1_174_3, spec_aug_params, audio_aug_params, None, [1,0])
    print("Job dir: {}".format(parameters.job_dir))

...
from modules.models.leaf_model9_model_101 import leaf_model9_model_101
...
class MyLRSchedule(tf.keras.optimizers.schedules.LearningRateSchedule):
  ...
  def __call__(self, step):
    ...
    # self.ident
    return self.initial_learning_rate / tf.math.ceil((step+1)/ (3*(2492 / parameters.batch_size)))
...
if __name__ == "__main__":
    ...
    spec_aug_params = []
    audio_aug_params = []
    launch_job({"Bd": 0, "Jordan": 0, "Icbhi": 1, "Perch": 0, "Ant": 0, "SimAnt": 0,}, leaf_model9_model_101, spec_aug_params, audio_aug_params, None, [1,0])

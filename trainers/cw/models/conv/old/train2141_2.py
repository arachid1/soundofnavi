...
def train_model(train_file, **args):
    job_dir = '../../new_cache/conv__2141__05_1641__v29__mod9_nocw/'
    ...
    for model_path in models:
        ...
        bd_f1, bd_accuracy, bd_precision, bd_recall, bd_auc, bd_y_true, bd_y_pred = generate_bangladesh_sheet(model, grouped_val_samples, excel_dest, six, initial_channels, 3)
        if target == 0: # auc 

...
def train_model(datasets, model_to_be_trained, spec_aug_params, audio_aug_params, parse_function, label_passed):
    ...
    # teacher
    teacher = model_to_be_trained(num_outputs=parameters.n_classes, _frontend=frontend.Leaf(sample_rate=16000, n_filters=80, preemp=True), normalize=True, encoder=None)
...
if __name__ == "__main__":
    ...
    spec_aug_params = []
    audio_aug_params = []
    launch_job({"Bd": 0, "Jordan": 0, "Icbhi": 1, "Perch": 1, "Ant": 1, "SimAnt": 1,}, leaf_model9_model_bis, spec_aug_params, audio_aug_params, None, [1,0])

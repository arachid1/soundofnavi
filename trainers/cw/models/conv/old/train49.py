...
def train_model(datasets, model_to_be_trained, spec_aug_params, audio_aug_params, parse_function):
    ...
    # teacher
    teacher = leaf_mixednet_model(num_outputs=parameters.n_classes, frontend=frontend.MelFilterbanks(sample_rate=16000, n_filters=80, window_len=25, window_stride=10), encoder=None)
    ...
    # teacher.load_weights("/home/alirachidi/classification_algorithm/cache/cw/train44/1/teacher_40")
    ...
    teacher.save_weights(parameters.job_dir + "/teacher_{}".format(parameters.n_epochs))


    #student
    student = leaf_model9_model(num_outputs=parameters.n_classes, frontend=frontend.MelFilterbanks(sample_rate=16000, n_filters=80, window_len=25, window_stride=10), encoder=None)
    shape = (None, parameters.audio_length*parameters.sr)
    student.build(shape)
    ...
    distiller.student.save_weights(parameters.job_dir + "/student_{}".format(parameters.n_epochs))

...
# class metric_callback(tf.keras.callbacks.LambdaCallback):
...
def train_model(train_file, **args):
    ...
    job_list = [[['v36','v37'], 500, [1, 500, 1, 1, 1]], [['v36'], 1000, [1, 500, 0, 0, 1]], [['v37'], 1000, [1,500, 0, 1, 0]], [['v36','v37'], 250, [1, 500, 1, 0, 0]], [['v37'], 500, [1, 1000, 1, 1, 1]]]
    # ['v38'], 500, [0, 0, 0, 0, 0]]]

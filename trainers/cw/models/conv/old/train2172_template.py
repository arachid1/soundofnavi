...
def train_model(train_file, job_dir, params, wav_params, spec_params):
    ...
    #######
    #######
    ##### TODO: CHANGE LR adjustment + change shape (pass channels differently) + adjust parse functions 
    if concat:
        ...
        val_dataset, train_dataset = process_data(val_samples, train_samples, generate_spec, shape, batch_size, initial_channels, cuberooting)

...
def train_model(datasets, model_to_be_trained, spec_aug_params, audio_aug_params, parse_function, label_passed):
    ...
    # teacher
    teacher = model_to_be_trained(num_outputs=parameters.n_classes, frontend=frontend.Leaf(sample_rate=16000, n_filters=80, preemp=True, preemp_init=leaf_audio.initializers.PreempInit(alpha=0.87)), encoder=None)

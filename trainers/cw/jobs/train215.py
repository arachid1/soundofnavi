...
from modules.models.leaf_efnet1_autoencoder import leaf_efnet1_autoencoder
...
if __name__ == "__main__":
    ...
    launch_job({"Bd": 0, "Jordan": 0, "Icbhi": 1, "Perch": 0, "Ant": 0, "SimAnt": 0,}, leaf_efnet1_autoencoder, spec_aug_params, audio_aug_params, None, [1,0])
    print("Job dir: {}".format(parameters.job_dir))

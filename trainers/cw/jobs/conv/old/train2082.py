...
def train_model(train_file, **args):
    ...
    # model setting
     # Initializing models
    # file_path = "../../cache/conv___03_1000___all_sw_coch_preprocessed_v2_param_v26_augm_v0_cleaned_8000___redo_w_newdataset___2011/model.h5"
    file_path = "/home/alirachidi/classification_algorithm/cache/conv___04_0121___all_sw_coch_preprocessed_v2_param_v29_augm_v0_cleaned_8000___test___2049/third.h5"
    ...
    student_scratch = student_(**model_params)
    ...
    distiller.compile(
        optimizer=opt,
        metrics=[calc_accuracy, tf.keras.metrics.Precision(), tf.keras.metrics.Recall(), gen_confusion_matrix],
    ...
    student_scratch.compile(
        ...
        loss=loss,
        metrics=[
            calc_accuracy, tf.keras.metrics.Precision(), tf.keras.metrics.Recall(), gen_confusion_matrix
        ],
    )
    if gpus:
        for gpu in gpus:
    ...
    teacher.save(job_dir + "/teacher.h5")

...
from modules.models.mixednet import mixednet
...
if __name__ == "__main__":
    ...
    launch_job({"Bd": 0, "Jordan": 1, "Icbhi": 1, "Perch": 1, "Ant": 1, "SimAnt": 1,}, mixednet, spec_aug_params, audio_aug_params, spec_parser)

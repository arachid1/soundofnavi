...
def train_model(datasets, model_to_be_trained, spec_aug_params, audio_aug_params, parse_function, label_passed):
    ...
    for i in range(len(train_audios_c_dict)):
        ...
        # teacher._load("/home/alirachidi/classification_algorithm/cache/cw/train187/7/", "16")
        teacher._load("/home/alirachidi/classification_algorithm/cache/cw/train162/4/", "15")
        teacher.build(shape)
        ...
        student._load("/home/alirachidi/classification_algorithm/cache/cw/train195_helpercopy/2/", 9)

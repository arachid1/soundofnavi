...
class Model(pl.LightningModule):
    ...
    def __init__(self, threshold):
        ...
        self.spec_layer = Spectrogram.MelSpectrogramBis(n_fft=parameters.n_fft, sr=parameters.sr, n_mels=256, hop_length=parameters.hop_length, 
    ...
    for threshold in ["none"]:
        ...
        with torch.no_grad():
                for local_batch, local_labels in testloader:
                    ...
                    visualize_spec_bis(no_train_out, parameters.sr, "temp/outputs_{}_".format(threshold), title="orig_index_{}_label_{}".format(index, label_to_track))
                    break
        ...
        trainer = pl.Trainer(max_epochs=parameters.n_epochs, gpus=0)
        ...
        with torch.no_grad():
                for local_batch, local_labels in testloader:
                    ...
                    visualize_spec_bis(last_epoch_out, parameters.sr, "temp/end_outputs_{}_".format(threshold), title="orig_index_{}_label_{}".format(index, label_to_track))
                    break

...
from modules.models import mixednet, model9, time_series_model, audiomod1, audiomod2
...
if __name__ == "__main__":
    ...
    launch_job({"Icbhi": 1, "Jordan": 1, "Bd": 1, "Ant": 0, "Perch": 0}, audiomod1, spec_aug_params, audio_aug_params, None)

    #  # learning spec 
    parameters.trainable_fb = False
    parameters.to_decibel = True
    launch_job({"Icbhi": 1, "Jordan": 1, "Bd": 1, "Ant": 0, "Perch": 0}, audiomod1, spec_aug_params, audio_aug_params, None)

    #  # learning spec with dropout
    # parameters.trainable_fb = True
    # parameters.to_decibel = True
    # parameters.lr = 1e-4
    # launch_job({"Icbhi": 1, "Jordan": 1, "Bd": 1, "Ant": 0, "Perch": 0}, audio_model_w_dropout, spec_aug_params, audio_aug_params, None)

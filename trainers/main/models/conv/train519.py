...
def conv2d(N_CLASSES, SR, BATCH_SIZE, LR, SHAPE, WEIGHT_DECAY, LL2_REG, EPSILON):
    ...
    x = layers.AveragePooling2D(pool_size=POOL_SIZE, padding="same")(x)
    x = layers.BatchNormalization()(x)
    tower_1 = layers.Conv2D(648, (1,1), padding='same', activation='relu')(x)
    tower_1 = layers.Conv2D(648, (3,3), padding='same', activation='relu')(tower_1)
    tower_2 = layers.Conv2D(648, (1,1), padding='same', activation='relu')(x)
    tower_2 = layers.Conv2D(648, (5,5), padding='same', activation='relu')(tower_2)
    tower_3 = layers.MaxPooling2D((3,3), strides=(1,1), padding='same')(x)
    tower_3 = layers.Conv2D(648, (1,1), padding='same', activation='relu')(tower_3)
    x = layers.Concatenate(axis=3)([tower_1, tower_2, tower_3])
    x = layers.AveragePooling2D(pool_size=POOL_SIZE, padding="same")(x)
    x = layers.BatchNormalization()(x)
    tower_1 = layers.Conv2D(1944, (1,1), padding='same', activation='relu')(x)
    tower_1 = layers.Conv2D(1944, (3,3), padding='same', activation='relu')(tower_1)
    tower_2 = layers.Conv2D(1944, (1,1), padding='same', activation='relu')(x)
    tower_2 = layers.Conv2D(1944, (5,5), padding='same', activation='relu')(tower_2)
    tower_3 = layers.MaxPooling2D((3,3), strides=(1,1), padding='same')(x)
    tower_3 = layers.Conv2D(1944, (1,1), padding='same', activation='relu')(tower_3)
    x = layers.Concatenate(axis=3)([tower_1, tower_2, tower_3])
    x = layers.AveragePooling2D(pool_size=POOL_SIZE, padding="same")(x)
    x = layers.BatchNormalization()(x)

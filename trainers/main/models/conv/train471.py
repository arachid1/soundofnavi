...
def conv2d(N_CLASSES, SR, BATCH_SIZE, LR, SHAPE, WEIGHT_DECAY, LL2_REG, EPSILON):
    ...
    tower_1 = layers.Conv2D(8, (2,2), padding='same', activation='relu')(tower_1)
    tower_2 = layers.Conv2D(8, (1,1), padding='same', activation='relu')(x)
    tower_2 = layers.Conv2D(8, (6,6), padding='same', activation='relu')(tower_2)
    tower_3 = layers.MaxPooling2D((2,2), strides=(1,1), padding='same')(x)
    ...
    tower_1 = layers.Conv2D(16, (2,2), padding='same', activation='relu')(tower_1)
    tower_2 = layers.Conv2D(16, (1,1), padding='same', activation='relu')(x)
    tower_2 = layers.Conv2D(16, (6,6), padding='same', activation='relu')(tower_2)
    tower_3 = layers.MaxPooling2D((2,2), strides=(1,1), padding='same')(x)
    ...
    tower_1 = layers.Conv2D(32, (2,2), padding='same', activation='relu')(tower_1)
    tower_2 = layers.Conv2D(32, (1,1), padding='same', activation='relu')(x)
    tower_2 = layers.Conv2D(32, (6,6), padding='same', activation='relu')(tower_2)
    tower_3 = layers.MaxPooling2D((2,2), strides=(1,1), padding='same')(x)
    ...
    tower_1 = layers.Conv2D(64, (2,2), padding='same', activation='relu')(tower_1)
    tower_2 = layers.Conv2D(64, (1,1), padding='same', activation='relu')(x)
    tower_2 = layers.Conv2D(64, (6,6), padding='same', activation='relu')(tower_2)
    tower_3 = layers.MaxPooling2D((2,2), strides=(1,1), padding='same')(x)
    ...
    tower_1 = layers.Conv2D(128, (2,2), padding='same', activation='relu')(tower_1)
    tower_2 = layers.Conv2D(128, (1,1), padding='same', activation='relu')(x)
    tower_2 = layers.Conv2D(128, (6,6), padding='same', activation='relu')(tower_2)
    tower_3 = layers.MaxPooling2D((2,2), strides=(1,1), padding='same')(x)
    ...
    tower_1 = layers.Conv2D(256, (2,2), padding='same', activation='relu')(tower_1)
    tower_2 = layers.Conv2D(256, (1,1), padding='same', activation='relu')(x)
    tower_2 = layers.Conv2D(256, (6,6), padding='same', activation='relu')(tower_2)
    tower_3 = layers.MaxPooling2D((2,2), strides=(1,1), padding='same')(x)

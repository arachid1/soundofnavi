...
def conv2d(N_CLASSES, SR, BATCH_SIZE, LR, SHAPE, WEIGHT_DECAY, LL2_REG, EPSILON):
    ...
    tower_1 = layers.Conv2D(8, (4,4), padding='same', activation='relu')(tower_1)
    ...
    tower_3 = layers.MaxPooling2D((4,4), strides=(1,1), padding='same')(x)
    ...
    tower_1 = layers.Conv2D(16, (4,4), padding='same', activation='relu')(tower_1)
    ...
    tower_1 = layers.Conv2D(32, (4,4), padding='same', activation='relu')(tower_1)
    ...
    tower_1 = layers.Conv2D(64, (4,4), padding='same', activation='relu')(tower_1)
    ...
    tower_1 = layers.Conv2D(128, (4,4), padding='same', activation='relu')(tower_1)
    ...
    tower_1 = layers.Conv2D(256, (4,4), padding='same', activation='relu')(tower_1)

...
class leaf_efnet1_autoencoder(tf.keras.Model):
  ...
  def __init__(self,
    ...
    self._mel_frontend = leaf_frontend.MelFilterbanks(sample_rate=parameters.sr, 
    ...
    self._sinc_frontend = leaf_frontend.SincNet(sample_rate=parameters.sr, 
      n_filters=parameters.n_filters,
      # n_fft = parameters.n_fft,
      window_len = parameters.window_len,
      window_stride = parameters.window_stride
    ...
    self.decoder = tf.keras.Sequential([
            ...
            # layers.BatchNormalization(),
            # layers.Dropout(0.1),
            InvertedResidual(filters=3, strides=1, kernel_size=KERNEL_SIZE, padding="same"),

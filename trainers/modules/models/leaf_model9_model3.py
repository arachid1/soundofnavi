...
class leaf_model9_model3(tf.keras.Model):
  ...
  def compute_mr_spectral_loss(self, x):
    ...
    #   tf.print(tf.reduce_max(mel_spec))
    #   tf.print(tf.reduce_min(mel_spec))
    #   tf.print(tf.reduce_mean(tf.math.square(mel_spec-spec)))

...
def train_model(train_file, job_dir, params, wav_params, spec_params, model_to_be_trained, job_count):
    ...
    print("ICBHI Pneumonia patients: {}, ICBHI Non-pneumonia patients: {}".format(nb_pneumonia, nb_non_pneumonia))
    ...
    new_samples = list(zip(new_filenames, new_labels))
    new_val_samples, new_train_samples = train_test_split(new_samples, test_size=train_test_ratio)
    ...
    val_samples += new_val_samples

    indices_to_vis = random.sample(range(len(val_samples)), 10)
    ...
    if concat:
        ...
        if augmentation:
            ...
            train_samples, train_labels = manage_label_augmentations(train_samples, wav_add, spec_add, 600, 600, job_version, wav_path, time_masking, frequency_masking, loudness, dataset_path, label=0, subfolder='augmented_2')
...
if __name__ == "__main__":
    ...
    print("-----------------------")
    print("Changing augmentation to v43")
    ...
    print("-----------------------")
    print("Changing augmentation to v48")
    wav_params['WAV_PATH'] = 'v48'
    print("Audio Augmentation Parameters: {}".format(wav_params))
    train_model(train_file, job_dir, params, wav_params, spec_params, model9, job_count=2)
    print("-----------------------")
    print("Changing augmentation to v42, v43")
    ...
    print("Changing augmentation to time/frequency masking")
    wav_params['ADD'] = 0
    spec_params['ADD'] = 1
    print("Audio Augmentation Parameters: {}".format(wav_params))
    print("Spec Augmentation Parameters: {}".format(spec_params))
    train_model(train_file, job_dir, params, wav_params, spec_params, model9, job_count=4)
    print("-----------------------")

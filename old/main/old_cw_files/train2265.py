...
def lstm_model(N_CLASSES, SR, BATCH_SIZE, LR, SHAPE, INITIAL_CHANNELS, WEIGHT_DECAY, LL2_REG, EPSILON, LABEL_SMOOTHING):

    KERNELS = [2, 3, 4, 5, 6, 7, 8]
    KERNEL_SIZE = 6
    POOL_SIZE = (2, 2)
...
if __name__ == "__main__":
    ...
    print("-----------------------")
    train_model(train_file, job_dir, params, wav_params, spec_params, lstm_model, job_count=0)
    # print("-----------------------")
    # print("Mixednet")

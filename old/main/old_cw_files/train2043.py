...
def train_model(train_file, **args):
    ...
    with tf.device('/CPU:0'): 
        ...
        # val_dataset = val_dataset.prefetch(len(val_filenames))
    ...
    filepath = "../../cache/conv___03_0544___all_sw_coch_preprocessed_v2_param_v26_augm_v0_cleaned_8000___test___2015/model.h5"
    # filepath = "../../cache/conv___04_0927___all_sw_coch_preprocessed_v2_param_v26_augm_v0_cleaned_8000___redo___2035/model.h5"

    model.load_weights(filepath)


    X = np.concatenate([x for x, y in val_dataset], axis=0)

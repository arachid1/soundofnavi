...
def train_model(train_file, job_dir, params, wav_params, spec_params, model_to_be_trained, job_count):
    ...
    indices_to_vis = random.sample(range(len(val_samples)), 15)
    ...
    if concat:
        ...
        if augmentation:
            train_samples, train_labels = manage_label_augmentations(train_samples, wav_add, spec_add, wav_quantity, spec_quantity, job_version, wav_path, time_masking, frequency_masking, loudness, dataset_path, label=1, subfolder='augmented_3')
            train_samples, train_labels = manage_label_augmentations(train_samples, wav_add, spec_add, 600, 600, job_version, wav_path, time_masking, frequency_masking, loudness, dataset_path, label=0, subfolder='augmented_4')

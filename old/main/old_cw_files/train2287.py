...
def train_model(train_file, job_dir, params, wav_params, spec_params, model_to_be_trained, job_count, repeat_factor):
...
if __name__ == "__main__":
    ...
    print("-----------------------")
    train_model(train_file, job_dir, params, wav_params, spec_params, mixednet, 0, 3)
    print("-----------------------")
    print("Repeat factor of 4")
    train_model(train_file, job_dir, params, wav_params, spec_params, mixednet, 0, 4)
    print("-----------------------")
    print("Repeat factor of 5")
    train_model(train_file, job_dir, params, wav_params, spec_params, mixednet, 0, 5)

...
if __name__ == "__main__":
    ...
    audio_aug_params = [["augmix", {"quantity" : 0.3, "label": -1, "no_pad" : False, "minval" : 0.3, "maxval" : 0.7, "aug_functions": [shift_pitch]}]]
    initialize_job()
    ...
    audio_aug_params = [["augmix", {"quantity" : 0.3, "label": -1, "no_pad" : False, "minval" : 0.1, "maxval" : 0.9, "aug_functions": [shift_pitch]}]]
    initialize_job()
    train_model(time_series_model, spec_aug_params, audio_aug_params)
    spec_aug_params = [["mixup", {"quantity" : 2, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.1, "maxval" : 0.9}],
       ["cutmix", {"quantity" : 2, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.1, "maxval" : 0.9}]]
    audio_aug_params = [["augmix", {"quantity" : 1, "label": 1, "no_pad" : False, "minval" : 0.1, "maxval" : 0.9, "aug_functions": [shift_pitch]}]]
    initialize_job()
    train_model(time_series_model, spec_aug_params, audio_aug_params)
    spec_aug_params = [["mixup", {"quantity" : 2, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.1, "maxval" : 0.9}],
       ["cutmix", {"quantity" : 2, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.1, "maxval" : 0.9}]]
    audio_aug_params = [["augmix", {"quantity" : 0.1, "label": -1, "no_pad" : False, "minval" : 0.1, "maxval" : 0.9, "aug_functions": [stretch_time]}], 
    ["augmix", {"quantity" : 0.1, "label": -1, "no_pad" : False, "minval" : 0.1, "maxval" : 0.9, "aug_functions": [shift_pitch]}]]
    initialize_job()

...
def train_model(model_to_be_trained, spec_aug_params, audio_aug_params, random_state):
...
if __name__ == "__main__":
    ...
    spec_aug_params = []
    audio_aug_params = []
    train_model(mixednet, spec_aug_params, audio_aug_params, 34)
    # initialize_job()
    # train_model(mixednet, spec_aug_params, audio_aug_params, 21)
    # initialize_job()
    # train_model(mixednet, spec_aug_params, audio_aug_params, 12)
    # initialize_job()
    # train_model(mixednet, spec_aug_params, audio_aug_params, 14)
    # initialize_job()
    # train_model(mixednet, spec_aug_params, audio_aug_params, 67)

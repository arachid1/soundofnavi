...
if __name__ == "__main__":
    ...
    print(wav_params)
    train_model(train_file, job_dir, params, wav_params, spec_params, mixednet, 1, 158, 400, repeat_factor=1)
    print("-----------------------")
    print("158/800 with v42,v43")
    wav_params['WAV_PATH'] = 'v42,v43'
    print(wav_params)
    train_model(train_file, job_dir, params, wav_params, spec_params, mixednet, 2, 158, 400, repeat_factor=1)

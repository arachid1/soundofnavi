...
def train_model(train_file, job_dir, params, wav_params, spec_params, model_to_be_trained, job_count, pneumonia_augmix_quantity, non_pneumonia_augmix_quantity):
    ...
    if concat:
        ...
        #     train_slice_one = train_slice_one.repeat(2) 
...
if __name__ == "__main__":
    ...
    # print("-----------------------")
    # train_model(train_file, job_dir, params, wav_params, spec_params, mixednet, 0, 158, 400)
    # print("-----------------------")
    # print("158/400 with v43")
    # wav_params['WAV_PATH'] = 'v43'
    # print(wav_params)
    # train_model(train_file, job_dir, params, wav_params, spec_params, mixednet, 1, 158, 400)
    print("-----------------------")
    print("158/800 with v42, v43")
    wav_params['WAV_PATH'] = 'v42,v43'
    print(wav_params)
    train_model(train_file, job_dir, params, wav_params, spec_params, mixednet, 2, 158, 800)
    print("-----------------------")
    print("158/1200 with v42, v43")
    print(wav_params)
    train_model(train_file, job_dir, params, wav_params, spec_params, mixednet, 3, 158, 1200)

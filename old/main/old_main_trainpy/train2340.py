...
if __name__ == "__main__":
    ...
    print("N_mels: ".format(parameters.n_mels))
    print("parameters.hop_length: ".format(parameters.hop_length))
    initialize_folder()
    print("-----------------------")
    initialize_job()
    spec_aug_params = []
    ...
    audio_aug_params = [["augmix", {"quantity" : 0.4, "label": -1, "no_pad" : False, "minval" : 0.3, "maxval" : 0.7, "aug_functions": [shift_pitch]}]]
    train_model(mixednet, spec_aug_params, audio_aug_params)
    initialize_job()

...
from .modules.callbacks.MetricsCallback import MetricsCallback, CustomMetricsCallback

from .models import custom_mixednet, model9
...
if __name__ == "__main__":
    ...
    spec_aug_params = []
    audio_aug_params = []
    train_model(custom_mixednet, spec_aug_params, audio_aug_params)

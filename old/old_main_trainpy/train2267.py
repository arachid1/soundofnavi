...
def train_model(train_file, job_dir, params, wav_params, spec_params, model_to_be_trained, job_count, mixup_quantity):
...
if __name__ == "__main__":
    ...
    print("-----------------------")
    train_model(train_file, job_dir, params, wav_params, spec_params, mixednet, job_count=0, mixup_quantity=800)
    print("-----------------------")
    print("model 9 with 2000 mixup quantity")
    train_model(train_file, job_dir, params, wav_params, spec_params, model9, job_count=1, mixup_quantity=2000)
    print("-----------------------")

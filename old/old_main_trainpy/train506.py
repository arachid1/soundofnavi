...
def conv2d(N_CLASSES, SR, BATCH_SIZE, LR, SHAPE, WEIGHT_DECAY, LL2_REG, EPSILON):
    ...
    y = layers.BatchNormalization()(i)
    tower_1 = layers.TimeDistributed(layers.Conv1D(8, kernel_size=(1), padding="same", activation='relu'))(y)
    tower_1 = layers.TimeDistributed(layers.Conv1D(8, kernel_size=(3), padding="same", activation='relu'))(tower_1)
    tower_2 = layers.TimeDistributed(layers.Conv1D(8, kernel_size=(1), padding="same", activation='relu'))(y)
    tower_2 = layers.TimeDistributed(layers.Conv1D(8, kernel_size=(5), padding="same", activation='relu'))(tower_2)
    tower_3 = layers.AveragePooling2D(3, strides=1, padding='same')(y)
    tower_3 = layers.TimeDistributed(layers.Conv1D(8, 1, padding='same', activation='relu'))(tower_3)
    y = layers.Concatenate(axis=3)([tower_1, tower_2, tower_3])
    y = layers.AveragePooling2D(pool_size=(2,2), padding="same")(y)
    y = layers.BatchNormalization()(y)
    tower_1 = layers.TimeDistributed(layers.Conv1D(16, kernel_size=(1), padding="same", activation='relu'))(y)
    tower_1 = layers.TimeDistributed(layers.Conv1D(16, kernel_size=(3), padding="same", activation='relu'))(tower_1)
    tower_2 = layers.TimeDistributed(layers.Conv1D(16, kernel_size=(1), padding="same", activation='relu'))(y)
    ...
    y = layers.AveragePooling2D(pool_size=(2,2), padding="same")(y)
    y = layers.BatchNormalization()(y)
    tower_1 = layers.TimeDistributed(layers.Conv1D(32, kernel_size=(1), padding="same", activation='relu'))(y)
    tower_1 = layers.TimeDistributed(layers.Conv1D(32, kernel_size=(3), padding="same", activation='relu'))(tower_1)
    tower_2 = layers.TimeDistributed(layers.Conv1D(32, kernel_size=(1), padding="same", activation='relu'))(y)
    ...
    y = layers.AveragePooling2D(pool_size=(2,2), padding="same")(y)
    y = layers.BatchNormalization()(y)
    tower_1 = layers.TimeDistributed(layers.Conv1D(64, kernel_size=(1), padding="same", activation='relu'))(y)
    tower_1 = layers.TimeDistributed(layers.Conv1D(64, kernel_size=(3), padding="same", activation='relu'))(tower_1)
    tower_2 = layers.TimeDistributed(layers.Conv1D(64, kernel_size=(1), padding="same", activation='relu'))(y)
    ...
    y = layers.AveragePooling2D(pool_size=(2,2), padding="same")(y)
    y = layers.BatchNormalization()(y)
    tower_1 = layers.TimeDistributed(layers.Conv1D(128, kernel_size=(1), padding="same", activation='relu'))(y)
    tower_1 = layers.TimeDistributed(layers.Conv1D(128, kernel_size=(3), padding="same", activation='relu'))(tower_1)
    tower_2 = layers.TimeDistributed(layers.Conv1D(128, kernel_size=(1), padding="same", activation='relu'))(y)
    ...
    y = layers.AveragePooling2D(pool_size=(2,2), padding="same")(y)
    y = layers.BatchNormalization()(y)
    tower_1 = layers.TimeDistributed(layers.Conv1D(256, kernel_size=(1), padding="same", activation='relu'))(y)
    tower_1 = layers.TimeDistributed(layers.Conv1D(256, kernel_size=(3), padding="same", activation='relu'))(tower_1)
    tower_2 = layers.TimeDistributed(layers.Conv1D(256, kernel_size=(1), padding="same", activation='relu'))(y)
    tower_2 = layers.TimeDistributed(layers.Conv1D(256, kernel_size=(5), padding="same", activation='relu'))(tower_2)
    tower_3 = layers.AveragePooling2D(3, strides=1, padding='same')(y)
    tower_3 = layers.TimeDistributed(layers.Conv1D(256, 1, padding='same', activation='relu'))(tower_3)
    y = layers.Concatenate(axis=3)([tower_1, tower_2, tower_3])
    y = layers.AveragePooling2D(pool_size=(2,2), padding="same")(y)
    y = layers.BatchNormalization()(y)
    ...
    z = layers.Concatenate(axis=3)([x, y])
     
    z = layers.GlobalAveragePooling2D()(z)
    z = layers.BatchNormalization()(z)
    z = layers.Dropout(rate=0.1)(z)
    z = layers.Dense(64, activation='relu', activity_regularizer=l2(0))(z)
    o = layers.Dense(N_CLASSES, activity_regularizer=l2(
        LL2_REG), activation="sigmoid")(z)
    # delete above

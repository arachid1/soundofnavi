...
if __name__ == "__main__":
    ...
    initialize_job()
    spec_aug_params = [
        ["mixup", {"quantity" : 4, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.2, "maxval" : 0.8}],
        ["cutmix", {"quantity" : 4, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.2, "maxval" : 0.8}],
        ["mixup", {"quantity" : 2, "no_pad" : True, "label_one" : 1, "label_two" : 1, "minval" : 0.2, "maxval" : 0.8}],
        ["cutmix", {"quantity" : 0.1, "no_pad" : True, "label_one" : 0, "label_two" : 0, "minval" : 0.2, "maxval" : 0.8}],
       ]
    audio_aug_params = [
        ["augmix", {"quantity" : 4, "label": 1, "no_pad" : False, "minval" : 0.2, "maxval" : 0.8, "aug_functions": [stretch_time]}], 
        ["augmix", {"quantity" : 4, "label": 1, "no_pad" : False, "minval" : 0.2, "maxval" : 0.8, "aug_functions": [shift_pitch]}],
        # ["augmix", {"quantity" : 0.1, "label": 0, "no_pad" : False, "minval" : 0.2, "maxval" : 0.8, "aug_functions": [stretch_time]}], 
        # ["augmix", {"quantity" : 0.1, "label": 0, "no_pad" : False, "minval" : 0.2, "maxval" : 0.8, "aug_functions": [shift_pitch]}]
        ]

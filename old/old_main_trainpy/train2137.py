...
def train_model(train_file, **args):
    ...
    with tf.device('/CPU:0'): 
        ...
        if concat:
            ...
            # print(len(oversampled_pneumonia_samples))
            # print(len(non_pneumonia_samples))
        ...
        metrics_callback = metric_callback(val_dataset, shape, n_classes, job_dir, min_delta, es_patience, patience, min_lr, factor, epoch_start, target, 'weighted')

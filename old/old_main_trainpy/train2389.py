...
if __name__ == "__main__":
    ...
    print("-----------------------")
    initialize_job()
    spec_aug_params = [["mixup", {"quantity" : 0.5, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}],
       ["cutmix", {"quantity" : 0.5, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}]]
    audio_aug_params = [["augmix", {"quantity" : 0.1, "label": -1, "no_pad" : False, "minval" : 0.3, "maxval" : 0.7, "aug_functions": [stretch_time]}]]
    train_model(time_series_model, spec_aug_params, audio_aug_params)
    initialize_job()
    spec_aug_params = [["mixup", {"quantity" : 0.5, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}],
       ["cutmix", {"quantity" : 0.5, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}]]
    audio_aug_params = [["augmix", {"quantity" : 0.1, "label": -1, "no_pad" : False, "minval" : 0.3, "maxval" : 0.7, "aug_functions": [shift_pitch]}]]
    train_model(time_series_model, spec_aug_params, audio_aug_params)
    initialize_job()
    ...
    spec_aug_params = [
        ...
        ["cutmix", {"quantity" : 0.2, "no_pad" : False, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}],
        ["mixup", {"quantity" : 0.2, "no_pad" : False, "label_one" : 1, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}],
        ["cutmix", {"quantity" : 0.1, "no_pad" : False, "label_one" : 0, "label_two" : 0, "minval" : 0.3, "maxval" : 0.7}],
    ]
    audio_aug_params = [
        ["augmix", {"quantity" : 0.3, "label": -1, "no_pad" : False, "minval" : 0.3, "maxval" : 0.7, "aug_functions": [stretch_time, shift_pitch]}], 
    ]
    train_model(time_series_model, spec_aug_params, audio_aug_params)

...
def train_model(train_file, **args):
    ...
    if gpus:
        for gpu in gpus:
            distiller.fit(train_dataset, validation_data=val_dataset, verbose=2, epochs=n_epochs)
    ...
    if gpus:
        for gpu in gpus:
            student_scratch.fit(train_dataset, validation_data=val_dataset, verbose=2, epochs=n_epochs)

    teacher.save(job_dir + "/teacher.h5")
    # distiller.save(job_dir + "/distill_model.h5")

...
def conv2d(N_CLASSES, SR, BATCH_SIZE, LR, SHAPE, WEIGHT_DECAY, LL2_REG, EPSILON, LABEL_SMOOTHING):
    ...
    tower_1 = layers.Conv2D(4, (1,1), padding='same', activation='relu')(i)
    tower_1 = layers.Conv2D(4, (3,3), padding='same', activation='relu')(tower_1)
    tower_2 = layers.Conv2D(4, (1,1), padding='same', activation='relu')(i)
    tower_2 = layers.Conv2D(4, (5,5), padding='same', activation='relu')(tower_2)
    tower_3 = layers.MaxPooling2D((3,3), strides=(1,1), padding='same')(i)
    ...
    x = layers.Conv2D(12, (3, 3), padding='same', activation='relu')(i)
    x = layers.AveragePooling2D(pool_size=POOL_SIZE, padding="same")(x)
    x = layers.BatchNormalization()(x)

...
def train_model(model_to_be_trained, spec_aug_params, audio_aug_params):
    ...
    # split and extend
    train_audios_c_dict, val_audios_c_dict = split_and_extend(audios_c_dict, parameters.train_test_ratio, random_state=15)
...
if __name__ == "__main__":
    ...
    initialize_job()
    spec_aug_params = [
        ["mixup", {"quantity" : 3, "no_pad" : False, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}],
        ["cutmix", {"quantity" : 3, "no_pad" : False, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}],
        ["mixup", {"quantity" : 3, "no_pad" : False, "label_one" : 1, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}],
        ["cutmix", {"quantity" : 3, "no_pad" : False, "label_one" : 1, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}],
        ["mixup", {"quantity" : 0.1, "no_pad" : False, "label_one" : 0, "label_two" : 0, "minval" : 0.3, "maxval" : 0.7}],
        ["cutmix", {"quantity" : 0.1, "no_pad" : False, "label_one" : 0, "label_two" : 0, "minval" : 0.3, "maxval" : 0.7}],
       
       ]
    audio_aug_params = [
        ["augmix", {"quantity" : 5, "label": 1, "no_pad" : False, "minval" : 0.3, "maxval" : 0.7, "aug_functions": [stretch_time]}], 
        ["augmix", {"quantity" : 5, "label": 1, "no_pad" : False, "minval" : 0.3, "maxval" : 0.7, "aug_functions": [shift_pitch]}],
        ["augmix", {"quantity" : 0.07, "label": 0, "no_pad" : False, "minval" : 0.3, "maxval" : 0.7, "aug_functions": [stretch_time]}], 
        ["augmix", {"quantity" : 0.07, "label": 0, "no_pad" : False, "minval" : 0.3, "maxval" : 0.7, "aug_functions": [shift_pitch]}],
        ]

...
def train_model(datasets, model_to_be_trained, spec_aug_params, audio_aug_params, parse_function, bd_root):
...
def launch_job(datasets, model, spec_aug_params, audio_aug_params, parse_function, bd_root):
    initialize_job()
    train_model(datasets, model, spec_aug_params, audio_aug_params, parse_function, bd_root)
...
if __name__ == "__main__":
    ...
    bd_root = '../../data/PCV_SEGMENTED_Simple_Filter/'
    launch_job({"Icbhi": 0, "Jordan": 0, "Bd": 1}, audio_model, spec_aug_params, audio_aug_params, generate_spec, bd_root)

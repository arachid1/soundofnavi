...
def generator(filenames, labels, shape, initial_channels):
    print(filenames)
    print(labels)
    for i in range(len(filenames)):
        ...
        yield 1, 0
        # yield {"input_1" : filenames[i]}, labels[i]
...
def train_model(train_file, **args):
    ...
    with tf.device('/CPU:0'): 
        ...
        train_dataset = tf.data.Dataset.from_generator(generator, args=(filenames, labels, shape, initial_channels), output_signature=(

...
def train_model(model_to_be_trained, spec_aug_params, audio_aug_params):
    ...
    # print("start")
    # print(len(audios_c_dict['Icbhi'][0]))
    # print(audios_c_dict['Icbhi'][0])
    # print("ok")
    # print(len(audios_c_dict['Jordan'][0]))
    # print(audios_c_dict['Jordan'][0])
    # print("split")
...
if __name__ == "__main__":
    ...
    parameters.train_test_ratio = 0.8
    ...
    train_model(mixednet, spec_aug_params, audio_aug_params)
    initialize_job()
    spec_aug_params = [["cutmix", {"quantity" : 1, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}]]
    train_model(mixednet, spec_aug_params, audio_aug_params)
    initialize_job()
    spec_aug_params = [["cutmix", {"quantity" : 4, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}]]
    train_model(mixednet, spec_aug_params, audio_aug_params)

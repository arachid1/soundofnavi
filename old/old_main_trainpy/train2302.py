...
if __name__ == "__main__":
    ...
    print("-----------------------")
    print("repeat factor of 2")
    train_model(train_file, job_dir, params, wav_params, spec_params, mixednet, 0, 158, 400, repeat_factor=2)
    print("-----------------------")
    print("repeat factor of 4")
    train_model(train_file, job_dir, params, wav_params, spec_params, model9, 0, 158, 400, repeat_factor=4)
    print("-----------------------")

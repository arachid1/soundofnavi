...
if __name__ == "__main__":
    ...
    print("-----------------------")
    initialize_job()
    spec_aug_params = [["mixup", {"quantity" : 5, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}],
       ["cutmix", {"quantity" : 5, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}]]
    audio_aug_params = [["augmix", {"quantity" : 1, "label": -1, "no_pad" : False, "minval" : 0.3, "maxval" : 0.7, "aug_functions": [shift_pitch, stretch_time]}]]
    train_model(mixednet, spec_aug_params, audio_aug_params)
    initialize_job()
    spec_aug_params = [["mixup", {"quantity" : 10, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}],
       ["cutmix", {"quantity" : 10, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}]]
    train_model(mixednet, spec_aug_params, audio_aug_params)
    initialize_job()
    spec_aug_params = [["mixup", {"quantity" : 15, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}],
       ["cutmix", {"quantity" : 15, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}]]
    train_model(mixednet, spec_aug_params, audio_aug_params)

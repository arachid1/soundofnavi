...
if __name__ == "__main__":
    ...
    parameters.train_test_ratio = 0.6
    ...
    print("-----------------------")
    initialize_job()
    spec_aug_params = [["mixup", {"quantity" : 5, "no_pad" : False, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}],
       ["cutmix", {"quantity" : 5, "no_pad" : False, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}]]
    audio_aug_params = [["augmix", {"quantity" : 6, "label": 1, "no_pad" : False, "minval" : 0.3, "maxval" : 0.7, "aug_functions": [stretch_time]}], 
    ["augmix", {"quantity" : 6, "label": 1, "no_pad" : False, "minval" : 0.3, "maxval" : 0.7, "aug_functions": [shift_pitch]}]]

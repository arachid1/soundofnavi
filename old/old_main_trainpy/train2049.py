...
def conv2d(N_CLASSES, SR, BATCH_SIZE, LR, SHAPE, WEIGHT_DECAY, LL2_REG, EPSILON, LABEL_SMOOTHING):
    ...
    model = Model(inputs=i, outputs=o, name="other")
...
def train_model(train_file, **args):
    ...
    # print("Transitioning to the other model (lower lr and more regularization) ")
    ...
    # model = other_model(**model_params)
    ...
    # model.save(job_dir + "/second.h5")

    # print("Last with label smoothing.")

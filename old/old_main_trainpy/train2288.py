...
if __name__ == "__main__":
    ...
    print("-----------------------")
    print("158/800")
    train_model(train_file, job_dir, params, wav_params, spec_params, mixednet, 0, 158, 800)
    print("-----------------------")
    print("158/2000")
    train_model(train_file, job_dir, params, wav_params, spec_params, mixednet, 0, 158, 2000)

...
if __name__ == "__main__":
    ...
    initialize_job()
    spec_aug_params = [["mixup", {"quantity" : 3, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}],
       ["cutmix", {"quantity" : 3, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}]]
    train_model(mixednet, spec_aug_params, audio_aug_params)
    initialize_job()
    spec_aug_params = [["mixup", {"quantity" : 4, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}],
       ["cutmix", {"quantity" : 4, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}]]
    train_model(mixednet, spec_aug_params, audio_aug_params)

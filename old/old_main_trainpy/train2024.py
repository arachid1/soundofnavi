...
def conv2d(N_CLASSES, SR, BATCH_SIZE, LR, SHAPE, WEIGHT_DECAY, LL2_REG, EPSILON, LABEL_SMOOTHING):
    ...
    tower_1 = Conv2DMoE(16, 2, (1, 1), expert_activation='relu', padding='same', gating_activation='sigmoid')(x)
    tower_1 = Conv2DMoE(16, 2, (3, 3), expert_activation='relu', padding='same', gating_activation='sigmoid')(tower_1)
    tower_2 = Conv2DMoE(16, 2, (1, 1), expert_activation='relu', padding='same', gating_activation='sigmoid')(x)
    tower_2 = Conv2DMoE(16, 2, (5, 5), expert_activation='relu', padding='same', gating_activation='sigmoid')(tower_2)
    tower_3 = layers.MaxPooling2D((3,3), strides=(1,1), padding='same')(x)
    tower_3 = Conv2DMoE(16, 2, (1, 1), expert_activation='relu', padding='same', gating_activation='sigmoid')(tower_3)

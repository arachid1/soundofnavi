...
from .models import mixednet, model9, time_series_model, audio_model_2
...
if __name__ == "__main__":
    ...
    launch_job({"Icbhi": 1, "Jordan": 1, "Bd": 0}, audio_model_2, spec_aug_params, audio_aug_params, None)

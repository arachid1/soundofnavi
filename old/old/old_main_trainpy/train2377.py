...
from .modules.callbacks.CustomMetricsCallback2 import CustomMetricsCallback2
...
def exp_decay(epoch):
    k = 0.2
    lr =  parameters.lr * math.exp(-k*epoch)
...
def train_model(model_to_be_trained, spec_aug_params, audio_aug_params):
    ...
    model.fit(
        ...
        callbacks=[metrics_callback, lrate_callback]
    )

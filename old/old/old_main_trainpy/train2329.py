...
if __name__ == "__main__":
    ...
    initialize_job()
    audio_aug_params = [["augmix", {"quantity" : 1, "label": -1, "no_pad" : False, "minval" : 0.3, "maxval" : 0.7, "aug_functions": [shift_pitch]}]]
    train_model(mixednet, spec_aug_params, audio_aug_params)
    initialize_job()
    audio_aug_params = [["augmix", {"quantity" : 1, "label": -1, "no_pad" : False, "minval" : 0.3, "maxval" : 0.7, "aug_functions": [stretch_time]}]]
    train_model(mixednet, spec_aug_params, audio_aug_params)

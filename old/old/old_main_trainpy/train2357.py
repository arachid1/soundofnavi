...
if __name__ == "__main__":
    ...
    spec_aug_params = [
        ["mixup", {"quantity" : 4, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}],
        ["cutmix", {"quantity" : 4, "no_pad" : True, "label_one" : 0, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}],
        ["mixup", {"quantity" : 2, "no_pad" : True, "label_one" : 1, "label_two" : 1, "minval" : 0.3, "maxval" : 0.7}],
        ["cutmix", {"quantity" : 0.1, "no_pad" : True, "label_one" : 0, "label_two" : 0, "minval" : 0.3, "maxval" : 0.7}],
       ]
    audio_aug_params = [

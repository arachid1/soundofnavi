...
def train_model(train_file, job_dir, params, wav_params, spec_params):
    ...
    if concat:
        train_labels = stratify_labels
        val_dataset, train_dataset = process_data(grouped_val_samples, grouped_train_samples, concatenate_timed_specs, shape, batch_size, initial_channels, cuberooting)
    else:
        print("-----------------------")

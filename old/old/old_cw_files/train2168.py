...
def generate_spec_w_norm(filename, label, shape, initial_channels):
    ...
    # tf.print(tf.reduce_max(spectrogram))
    # tf.print(tf.reduce_min(spectrogram))
...
def train_model(train_file, **args):
    ...
    with tf.device('/CPU:0'): 
        ...
        if concat:
            ...
            val_dataset, train_dataset = process_data(val_samples, train_samples, generate_spec_w_norm, shape, batch_size, initial_channels)

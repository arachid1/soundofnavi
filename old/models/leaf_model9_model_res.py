...
from ..main import parameters
# import classification_models as sm
from tensorflow import keras
from classification_models.keras import Classifiers



class leaf_model9_model_res(tf.keras.Model):
  ...
  def __init__(self,
    ...
    # model_obj, preprocess_input = Classifiers.get('resnet34')
    # model = model_obj(input_shape=parameters.shape, weights='imagenet', include_top=False)
    ...
    tf.print(self._pool.output_shape)
    self._final.build(self._pool.output_shape)
    self._final.summary()

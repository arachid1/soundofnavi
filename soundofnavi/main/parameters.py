...
def init(arguments, file_name):
    ...
    cache_root = Path(__file__).parent.parent.parent / 'cache' # IXME posix paths
    data_root = Path(__file__).parent.parent.parent / 'data'
    jordan_root = data_root / "jwyy9np4gv-3/"
    icbhi_root = data_root / "raw_audios/icbhi_preprocessed_v2_8000/"
    bd_root = data_root / "PCV_SEGMENTED_Processed_Files/"
    excel_path = data_root / "Bangladesh_PCV_onlyStudyPatients.xlsx"
    perch_root = data_root / "raw_audios/perch_8000_10seconds"
    ant_root = data_root / "raw_audios/Antwerp_Clinical_Complete"
    official_labels_path =  data_root / "raw_audios/icbhi_preprocessed_v2_8000/official_labels.txt"
    ...
    icbhi_metadata_root = data_root / "raw_audios/demographic_info.txt"

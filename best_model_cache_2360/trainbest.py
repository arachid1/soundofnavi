...
def train_model(datasets, model_to_be_trained, spec_aug_params, audio_aug_params, parse_function, validation_only):
    ...
    if validation_only: 
        model_path = '../../cache/pneumonia/old/new_cache/conv__2360__07_0723__v39__augmentation/0/model_epoch12.h5'
...
if __name__ == "__main__":
    ...
    launch_job({"Icbhi": 0, "Jordan": 0, "Bd": 1}, mixednet, spec_aug_params, audio_aug_params, generate_spec, validation_only)
